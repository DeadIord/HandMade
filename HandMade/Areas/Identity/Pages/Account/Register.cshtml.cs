...
namespace HandMade.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [EmailAddress(ErrorMessage = "Введите коректный Email")]
            [Display(Name = "Email")]
            ...
            [Compare("Password", ErrorMessage = "Пароль для подтверждения не совпадает.")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (_signInManager.IsSignedIn(User) && User.IsInRole("Admin") || User.IsInRole("Guest"))
                    {
